...
* Load XML with currency rate from "Moscow Exchange" (http://www.micex.ru/issrpc/marketdata/currency/selt/daily/download/micex_currency_selt_$date.xml) for USD/RUR and EUR/RUR
* Курс валют ЦБ РФ на текущий день c динамикой изменения курса RUR, RUB, EUR, USD.
